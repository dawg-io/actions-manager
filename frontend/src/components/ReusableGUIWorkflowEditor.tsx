...
interface ReusableGUIWorkflowEditorProps {
...
const ReusableGUIWorkflowEditor: React.FC<ReusableGUIWorkflowEditorProps> = ({
  workflow,
  onChange,
  onValidationChange,
  importedActions,
    ...
    <div className="gui-workflow-editor">
      ...
      <div className="form-section">
        ...
        <input
          ...
          placeholder="Enter reusable workflow name..."
          className={`form-input ${getFieldError('name') ? 'error' : ''}`}
        />
      </div>

      {/* Trigger Event - Always workflow_call for reusable workflows */}
      <div className="form-section">
        <label className="form-label">
          Trigger Event
...
export default ReusableGUIWorkflowEditor;
