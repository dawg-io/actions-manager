...
description: Diagnosing and resolving container startup issues for ActionsManager Self-Hosted.
---
...
**Solution:** Put ActionsManager behind an HTTPS reverse proxy and use an `https://` `APP_URL` (see [HTTPS Setup](../getting-started/https-setup.html)). To keep running over plain HTTP on a trusted network, add:
...
2. Review the [Common Errors](common-errors.html) page
...
- [Common Errors](common-errors.html) — authentication, API, and workflow errors
- [GitHub Permissions](github-permissions.html) — permission requirements
- [Installation](../getting-started/installation.html) — installation guide
