...
description: Required GitHub permissions for ActionsManager features.
---
...
- [GitHub PAT Setup](../getting-started/github-pat-setup.html) — creating tokens with correct permissions
- [Common Errors](common-errors.html) — error messages and solutions
- [Token Handling](../security/token-handling.html) — token security and storage
