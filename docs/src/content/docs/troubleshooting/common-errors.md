---
title: Common Errors
description: Quick reference for common errors and their solutions.
---
...
3. See [HTTPS Setup](../getting-started/https-setup.html) for per-proxy examples and a stop-gap override
...
- [GitHub Permissions](github-permissions.html) — GitHub permission requirements in detail
- [Container Startup](container-startup.html) — container startup and health issues
