...
<VideoPlayer
	sizes="(min-width: 72rem) 45rem, (min-width: 50rem) calc(100vw - 21.75rem), calc(100vw - 2rem)"
	loading="eager"
/>

The player loads from youtube-nocookie.com only after you press play. [Watch on YouTube ↗](https://youtu.be/WkDYK7pCBjI)
