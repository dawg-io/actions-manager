---
title: Build Metrics
description: See how your managed workflows actually perform — success rates, durations, queue time and trend — and click through to any individual run on GitHub.
---
...
- [Drift Detection](drift-detection.html) — whether the workflow *file* in GitHub still matches what
  ActionsManager manages, which is a different question from whether it passes
- [PR Campaigns](pr-campaigns.html) — delivering workflow changes to repositories
- [Notifications](notifications.html) — email and webhook alerts for drift and campaign events
