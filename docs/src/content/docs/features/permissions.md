---
title: Permissions
description: Who can see a project, and who can change it.
---
...
- creating a [PR campaign](pr-campaigns.html), and merging or closing
  its pull requests
- running preflight validation, and merging or closing the validation pull request
- rolling a campaign back
- saving, renaming or removing a [workflow](workflows.html)
- importing workflows
