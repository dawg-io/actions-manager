...
description: Automatically detect build types and suggest workflow templates for repositories by analyzing project files.
---
...
- [Workflows](workflows.html) — create and manage workflows in ActionsManager
- [Projects](projects.html) — group repositories for bulk workflow operations
