...
description: Take a complete copy of your installation before an upgrade, and restore it into a fresh one if something goes wrong.
---
...
[Deployment guide → Backup & Recovery](https://github.com/dawg-io/actions-manager/blob/main/docs/DEPLOYMENT.md#backup--recovery) covers scheduling
