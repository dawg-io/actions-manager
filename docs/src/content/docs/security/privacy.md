---
title: Privacy
description: How ActionsManager Self-Hosted Beta handles your data.
---
...
- [Security Policy](security.html) — hardening guidance and vulnerability reporting
- [Token Handling](token-handling.html) — GitHub token security
