...
description: Security information and hardening guidance for ActionsManager Self-Hosted Beta.
---
...
- [Privacy](privacy.html) — data handling and privacy information
- [Token Handling](token-handling.html) — GitHub token security practices
