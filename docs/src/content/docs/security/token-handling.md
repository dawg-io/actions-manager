...
description: How ActionsManager handles GitHub tokens and best practices for keeping credentials secure.
---
...
- [GitHub PAT Setup](../getting-started/github-pat-setup.html) — creating tokens with least privilege
- [GitHub OAuth Setup](../getting-started/github-oauth-setup.html) — configuring OAuth login
- [Security Policy](security.html) — hardening guidance
- [Privacy](privacy.html) — how token data is stored
