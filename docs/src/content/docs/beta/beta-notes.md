---
title: Beta Notes
description: What the beta is, what it is not, and what to expect.
---
...
- [Installation](../getting-started/installation.html) — getting started with self-hosted
- [Security Policy](../security/security.html) — beta security scope
- [Privacy](../security/privacy.html) — beta data handling
